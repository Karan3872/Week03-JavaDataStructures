...
public class TestingReadAndWriteToFile {

    @Test
    public void testReadInputAndWriteToFile() {
        // Define the file path for testing
        String filePath = "src/test/java/com/tit/day0405searchingreadingstringtype/inputstream/readuserinputandwritetofile/Large_File.txt";
        ...
        ReadAndWriteToFile reader = new ReadAndWriteToFile();
